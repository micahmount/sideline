...
const liveGame = { id: 'g1', teamId: 't1', profileId: 'p1', positionTemplateId: null, opponent: 'Wildcats', scheduledAt: '2026-04-01T10:00:00Z', periodCount: 2, periodLengthMinutes: 25, stoppageSeconds: 0, status: 'in_progress' as const }
const liveState = {
